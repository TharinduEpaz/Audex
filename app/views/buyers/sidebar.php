<div class="sidebar">
            <!-- <a id="profile" href="#" ><i class="fas fa-address-card"></i> <span>My Profile</span></a>
            <a id="watch_list" href="<?php echo URLROOT . '/users/watchlist';?>"> <i class="far fa-calendar-check" aria-hidden="true"></i><span>Watch List</span></a>
