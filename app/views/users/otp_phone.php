...
<head>
    ...
    <title>Verify phome number</title>
</head>
<body>
<?php require_once APPROOT . '/views/users/navbar.php';?>
    ...
    <div class="container_main">
        <div class="form" style="margin-top: 25vh;">
            ...
            <form action="<?php echo URLROOT . '/users/otp_phone/'.$data['id'];?>" method="post">
                <label >OTP(sent to <?php echo '0******'.$data['phone'][7].$data['phone'][8].$data['phone'][9]?>)</label>
                <div class="input">
