<div class="sidebar">
    ...
    <a id="profile"  href="<?php echo URLROOT;?>/admins/profiletest/<?php echo $_SESSION['user_id']?>"><i class="fa fa-user" aria-hidden="true"></i><span>My Profile</span></a>
    <a id="manage_users" href="<?php echo URLROOT;?>/admins/manageuser"> <i class="fa fa-cog" aria-hidden="true"></i><span>Manage Users</span></a>
    <a id="reports" href="<?php echo URLROOT;?>/admins/reports"> <i class="fa fa-file"></i><span>Reports</span></a>
